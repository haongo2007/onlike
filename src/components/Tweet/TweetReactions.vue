<template>
  <div class="meta">
    <a class="reply" @click="viewDetailTweet({name:'singletweet',id:tweet.id})">
      ...
      favoriteTweet () {
        ...
        axios
          ...
          .then(response => {
            ...
            response.data.data.tweet = this.tweet;
            this.$store.dispatch('favoriteTweet',response.data.data);
          })
      },
      unFavoriteTweet() {
        const token = localStorage.getItem('tweetr-token')
        ...
        axios
          ...
          .then(response => {
            ...
            this.$store.dispatch('unFavoriteTweet',this.tweet.id);
            this.$emit('update:favorites', filteredFavorites)
          })
      },
      viewDetailTweet (data) {
        this.$bus.$emit('ChangeContainTweetPage', data);
      }
    }
  }
</script>
